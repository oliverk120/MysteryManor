  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="max-w-2xl mx-auto p-6 space-y-8">
        ...
        <section>
          <h2 className="text-xl font-semibold text-blue-700 mb-2">Mission Brief</h2>
          ...
          <article className="space-y-4 border border-gray-300 rounded-md p-4 bg-gray-50">
            ...
            <ul className="list-disc ml-5 space-y-1 text-sm">
              ...
              <li className="mt-2 border-l-4 border-blue-600 pl-4">
                <span className="flex items-center font-semibold"><Target className="w-4 h-4 mr-2 text-blue-600" />Objective Tonight</span>
